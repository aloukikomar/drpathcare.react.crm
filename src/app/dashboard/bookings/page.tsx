...
import { BookingsFilters } from '@/components/dashboard/bookings/bookings-filters';
import { BookingsTable } from '@/components/dashboard/bookings/bookings-table';
import type { Bookings } from '@/components/dashboard/bookings/bookings-table';
...
function applyPagination(rows: Bookings[], page: number, rowsPerPage: number): Bookings[] {
